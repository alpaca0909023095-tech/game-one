...
window.GAME_CONFIG = {
  player: {
    ...
    maxHp: 100,               // 玩家最大血量。
    radius: 13,               // 玩家碰撞半徑。
    modelScale: 0.54,         // 玩家肉眼看到的模型倍率，1 為原始模型大小。
  ...
  bullet: {
    ...
    trailSizeMin: 4,          // 普通子彈尾端方塊最小尺寸。
    trailSizeMax: 6,          // 普通子彈尾端方塊最大尺寸。
  ...
  level: {
    duration: 20,             // 每一關固定持續時間。
    durationGrowth: 0,        // 每過一關增加的關卡秒數，0 代表固定關卡時間。
  ...
  reward: {
    coinPerEnemy: 0,          // 普通怪擊殺金幣，0 代表普通怪不掉錢。
    goldEnemyChanceA: 0.333,  // 敵人 A 生成為金色怪的機率。
    goldEnemyChanceB: 0.333,  // 敵人 B 生成為金色怪的機率。
    goldEnemyCoinA: 3,        // 金色敵人 A 擊殺後給的金幣。
    goldEnemyCoinB: 5,        // 金色敵人 B 擊殺後給的金幣。
  ...
  skills: {
    ...
    shockwave: {
      ...
      burstParticleSizeMin: 3,// 消失粒子最小尺寸。
      burstParticleSizeMax: 6,// 消失粒子最大尺寸。
      burstParticleTrackSpread: 1.3, // 消失粒子離衝擊波軌道的散布距離。
